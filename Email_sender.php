...
class Email_sender
{
	...
	// private $server = 'webmail.aarvitechno.com';
	private $server   = '{webmail.aarvitechno.com:143/novalidate-cert}Sent Items';
	// private $server   = '{webmail.aarvitechno.com:143/novalidate-cert}';

	// private $user   = 'email@yourserver.com';
	private $user   = 'no-reply@aarvitechno.com';
